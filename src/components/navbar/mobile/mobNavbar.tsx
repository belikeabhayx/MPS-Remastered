        ...
        <div className="relative z-50 w-full bg-white flex flex-col items-center pb-4 pt-4 xl:hidden">
            ...
            <div className="w-full px-4 flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                    <button onClick={() => setIsSidebarOpen(true)} aria-label="Toggle menu">
                        <Menu className="w-8 h-8 text-[#2b2f7f]" />
                    </button>
                    <Link href="/">
                        <Image
                            src="/logo.png"
                ...
                <div className="flex items-center gap-4">
                    ...
                    {/* <CartIndicator iconClassName="w-7 h-7 text-[#2b2f7f]" /> */}
                </div>
            </div>
            ...
            <div className="w-full px-4 mt-4">
                <form onSubmit={(e) => {
                    ...
                    if (input.value.trim()) {
                        router.push(`/catalogsearch/result/?q=${encodeURIComponent(input.value)}`);
                    }
