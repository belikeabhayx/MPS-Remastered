        ...
        <div className="w-full bg-white px-4 py-16 mb-64">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-16 space-y-4">
                    <h2 className="text-4xl md:text-5xl font-serif text-[#263586]">Blogs</h2>
                    <p className="text-[#00000099] max-w-3xl mx-auto text-sm md:text-lg">
                        Oil filters for Volvo Penta, Yanmar, Vetus, Nanni and other marine diesel engines. Use the filters to
                        quickly find the correct filter for your engine and keep your oil system in top condition.
                    </p>
                </div>
